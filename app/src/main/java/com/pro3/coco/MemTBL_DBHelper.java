...
public class MemTBL_DBHelper extends SQLiteOpenHelper { //DDL만 담당
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE memTBL (mId varchar(20), mPw varchar(20), mName varchar(50), mBirth varchar(10), mEmail varchar(50), mTel char(11));");
        Log.d("member_sqlite3DDL", "CREATE TABLE 호출함...!!!");
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        db.execSQL("DROP TABLE IF EXISTS memTBL");
